...
namespace BLL
{
	...
	{
		private readonly IGrade dal=DataAccess.CreateGrade();
		public Grade()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.Grade GetModelByCache(int GradeID)
		{
			
			string CacheKey = "GradeModel-" + GradeID;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Grade> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Grade> DataTableToList(DataTable dt)
		{
			List<Model.Grade> modelList = new List<Model.Grade>();
